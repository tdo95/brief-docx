        ...
        <Container sx={{p:3, display: 'flex', flexDirection:'column', alignItems:'center'}}>
            ...
            <Box sx={{display: 'flex', width: '100%', maxWidth:'1100px'}}>
              ...
              <Box sx={{width:'60%', display:'flex', flexDirection:'column', justifyContent: 'center'}}>
                ...
                <Typography sx={{fontSize: '20px', mb:'20px'}}>Brief Docx is a document formating tool that allows you to create and edit your documents in real time. Formatting is taken care of behind the scenes. This way you can focus on what really matters, the content!</Typography>
